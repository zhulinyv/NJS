    ...
    if not (
        ...
        try:
            await aiorequests.download(
                ...
                save_path=RESOURCE_BASE_PATH / '脑积水基础资源.zip')
            zipfile.ZipFile(RESOURCE_BASE_PATH / '脑积水基础资源.zip').extractall(RESOURCE_BASE_PATH)
            (RESOURCE_BASE_PATH / '脑积水基础资源.zip').unlink()
