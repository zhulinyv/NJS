...
可能有人会问，自己利用 NoneBot 或者 ZeroBot 等框架搭建一个不是更好嘛？我会实话告诉你，你是正确的。**但是**如果插件用多用久了，你就会发现，各种指令冲突、优先级冲突，数据库打架，依赖打架……
...
<summary>备注：Linux 服务器可能会出现中文乱码，此时需要安装中文字体。</summary>

感谢 [@DuuuLu](https://github.com/DuuuLu) 反馈。
