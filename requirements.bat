...
poetry run pip install cached-property==1.5.2
...
poetry run pip install inflection==0.5.1
...
poetry run pip install lazy_loader==0.2
...
poetry run pip install markdown-it-py==2.2.0
poetry run pip install MarkupSafe==2.1.1
poetry run pip install matplotlib==3.6.2
poetry run pip install mdurl==0.1.2
poetry run pip install mpmath==1.3.0
poetry run pip install msgpack==1.0.4
poetry run pip install multidict==6.0.2
poetry run pip install mypy-extensions==1.0.0
poetry run pip install nb-cli==0.6.7
poetry run pip install networkx==3.1
poetry run pip install ninja==1.11.1
...
poetry run pip install nonebot-plugin-chatrecorder==0.2.3
poetry run pip install nonebot-plugin-datastore==0.6.2
...
poetry run pip install pyclipper==1.3.0.post4
...
poetry run pip install python-bidi==0.4.2
...
poetry run pip install PyWavelets==1.4.1
...
poetry run pip install rich==13.3.2
...
poetry run pip install scikit-image==0.20.0
...
poetry run pip install SQLAlchemy==2.0.9
...
poetry run pip install sympy==1.11.1
...
poetry run pip install tifffile==2023.3.21
...
poetry run pip install torch==2.0.0
poetry run pip install torchvision==0.15.1
...
poetry run pip install typing-inspect==0.8.0
