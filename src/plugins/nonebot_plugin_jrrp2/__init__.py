...
jrrp = on_command("jrrp",None,aliases={'j','今日人品'})
@jrrp.handle()
...
alljrrp = on_command("alljrrp",None,aliases={'总人品','平均人品'})
@alljrrp.handle()
...
monthjrrp = on_command("monthjrrp",None,aliases={'本月人品', '月人品'})
@monthjrrp.handle()
...
weekjrrp = on_command("weekjrrp",None,aliases={'本周人品','周人品'})
@weekjrrp.handle()
